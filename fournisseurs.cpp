...
Fournisseur::Fournisseur(int Id,QString Nom_enteprise,QString Numero_telephone,QString Mail,QString Adresse,QString Type_fourniture)
{
  this->Id=Id;
  this->Nom_entreprise=Nom_enteprise;
...
query.prepare("INSERT INTO fournisseur (Id,Nom_etreprise,Numero_telephone,Mail,Adresse,Type_fourniture) "
                    "VALUES (:Id,:Nom_etreprise,:Numero_telephone,:Mail,:Adresse,:Type_fourniture)");
query.bindValue(":Id",res);
query.bindValue(":Nom_etreprise", Nom_entreprise);
query.bindValue(":nomNumero_telephone",Numero_telephone);
